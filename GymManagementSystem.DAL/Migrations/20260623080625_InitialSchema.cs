        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Speciality = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_User_Phone", "LEN([Phone]) = 11 AND [Phone] LIKE '01[0125]%'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MemberShip_DateRange", "[StartDate] < [EndDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Session_DateRange", "[StartDate] < [EndDate]");
                    table.ForeignKey(
